...
onkey, onclick = canvas.onkeypress, canvas.onscreenclick
turtle_speed = speed
...
class Game:
    ...
    class BaseCameraControls:
        ...
        def listen(self):
            onkey(self.lookup, "Up")
            onkey(self.lookdown, "Down")
            onkey(self.lookright, "Right")
            onkey(self.lookleft, "Left")

            # Not Really Useful
            # onkey(self.tiltright, "c")
            # onkey(self.tiltleft, "z")
